...
def plot_sequential(cost_list: list, sus=bool):
    ...
    for cost in cost_list:
        ...
        pdf_path = save_dir / f'figure5_hydrogen_plasma.pdf'
...
if __name__ == '__main__':
    ...
    n_stage = 2
    result_dir = base_dir / f'equivalent_circuit_cycle{max_cycle}/'
    title = 'Hydrogen plasma treatment ($N = 2$)'
